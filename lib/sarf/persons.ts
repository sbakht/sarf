...
export const PERSONS: PersonInfo[] = [
  { id: "huwa", arabic: "هُوَ", english: "he", person: 3, number: "sg", gender: "m" },
  { id: "huma_m", arabic: "هُمَا", english: "they two (m)", person: 3, number: "du", gender: "m" },
  { id: "hum", arabic: "هُمْ", english: "they (m)", person: 3, number: "pl", gender: "m" },
  { id: "hiya", arabic: "هِيَ", english: "she", person: 3, number: "sg", gender: "f" },
  { id: "huma_f", arabic: "هُمَا", english: "they two (f)", person: 3, number: "du", gender: "f" },
  { id: "hunna", arabic: "هُنَّ", english: "they (f)", person: 3, number: "pl", gender: "f" },
  { id: "anta", arabic: "أَنْتَ", english: "you (m)", person: 2, number: "sg", gender: "m" },
  { id: "antuma_m", arabic: "أَنْتُمَا", english: "you two", person: 2, number: "du", gender: "c" },
  { id: "antum", arabic: "أَنْتُمْ", english: "you (m pl)", person: 2, number: "pl", gender: "m" },
  { id: "anti", arabic: "أَنْتِ", english: "you (f)", person: 2, number: "sg", gender: "f" },
  { id: "antuma_f", arabic: "أَنْتُمَا", english: "you two", person: 2, number: "du", gender: "c" },
  { id: "antunna", arabic: "أَنْتُنَّ", english: "you (f pl)", person: 2, number: "pl", gender: "f" },
  { id: "ana", arabic: "أَنَا", english: "I", person: 1, number: "sg", gender: "c" },
  { id: "nahnu", arabic: "نَحْنُ", english: "we", person: 1, number: "pl", gender: "c" },
];
